<template>
  <div class="">
    ...
    >
      <div>
        <p
          class="p-2 text-4xl font-bold text-center text-blue-800 lg:mx-auto lg:w-4/6 lg:text-5xl lg:text-gray-100"
        >
        ...
        <div class="max-w-md p-4 bg-white rounded-lg shadow-lg">
          ...
          <div>
            ...
            L'entreprise elle-même est une entreprise très prospère. Lequel
               ces chagrins les abandonnent, et l'erreur née du chagrin, les choses que je déteste
               car il cherche ici par commodité, il s'engage à être moins épargné par la vérité
               résultat!
            </p>
          </div>
