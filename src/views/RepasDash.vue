    ...
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
      ...
      <tbody>
        ...
        >
          ...
          <td class="px-6 py-4"> {{repas.prix}}</td>
          <td class="px-6 py-4"> {{repas.type}}</td>
          <td class="px-6 py-4"> {{repas.restaurant.name}}</td>
              ...
              <div class="grid grid-cols-8 gap-6">
                ...
                <div class="col-span-8 sm:col-span-8">
                  ...
                  <div class="relative mt-1">
                    <BaseInput v-model="addform.type" class="mt-2" />
                  </div>
                </div>
                <div class="col-span-8 sm:col-span-8">
                 ...
                 <div class="col-span-8 sm:col-span-8">
                  <BaseLabel value="Choisissez le restaurant" />
                  <select
                    name="restaurant"
                    id="restaurant"
